...
# Ajan başlatıcı
bridge = AgentBridge(agent_id=100)
print(f"Agent-{str(100).zfill(3)} | Orchestrator'a bağlandı.")
...
# Ajan_100
# Uzmanlık: Strateji Uzmanı

def gorev_yap():
    return "Ben bir Strateji Uzmanı olarak görevimin başındayım."