...
def update_conversation_history():
    ...
    # File locations
    local_file = working_dir / "TRM_SOHBET_GECMISI.txt"
    desktop_file = desktop / "TRM_SOHBET_GECMISI.txt"
...
"""
    ...
    print(f"[OK] Yerel dosya güncellendi: {local_file}")
    
    # Copy to desktop
    import shutil
    shutil.copy2(local_file, desktop_file)
    print(f"[OK] Dosya masaüstüne kopyalandı: {desktop_file}")
    print("\nSohbet gecmisiniz basariyla guncellendi Mareselim!")
