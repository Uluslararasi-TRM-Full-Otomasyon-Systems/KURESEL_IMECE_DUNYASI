...
# -*- coding: utf-8 -*-
"""
TRM FULL OTOMASYON - ASCII SENKRONIZASYON KONTROLU
Google Drive ve Flash Bellek dosyalarini karsilastirir (Unicode olmadan)
"""
...
def check_sync_status():
    ...
    if len(flash_only) == 0 and len(system_only) == 0:
        print(f"\n[OK] TUM DOSYALAR ESLESMIS DURUMDA!")
